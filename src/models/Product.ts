...
export const products: Product[] = [
   {
      ...
      price: 19.99,
      description:
         'A soothing bath bomb with essential oils to provide a relaxing experience.',
   ...
   },
   {
      ...
      price: 34.99,
      description:
         'A sleek vape pen for a smooth and flavorful CBD experience.',
      type: [ProductType.SMOKABLE],
      photos: [
   ...
   },
   {
      ...
      price: 29.99,
      description:
         'CBD oil specially formulated for pets to help with anxiety and joint pain.',
      type: [ProductType.PETS],
      photos: [
   ...
   },
   {
      ...
      price: 15.99,
      description:
         'Delicious and chewy CBD-infused gummy bears for a sweet treat.',
      type: [ProductType.EDIBLES],
      photos: [
